...
using static Csla.Blazor.Client.Authentication.CslaUserService;
...
namespace KPSL.Collacteral.Client
{
  public class CurrentUserAuthenticationStateProvider : AuthenticationStateProvider, IDisposable
  {
    ...
    public CurrentUserAuthenticationStateProvider(CslaUserService CslaUserService)
    {
      _currentUserService = CslaUserService;
